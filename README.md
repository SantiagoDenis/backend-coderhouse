...
Por ejemplo, el día 17 de Septiembre del 2022 corrí los tests, se generó **`TestResults_2022-09-17.txt`** en la carpeta `testresults`

```console
cat testresults/TestResults_2022-09-17.txt
